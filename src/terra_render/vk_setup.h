...
VkInstanceCreateInfo terrar_create_instance_info(terrar_app *,
                                                 VkApplicationInfo *);
int terrar_check_validation_layer_support(terrar_app *);
terrar_queue terrar_find_queue_families(VkPhysicalDevice, VkSurfaceKHR);
uint32_t terrar_rate_device(terrar_app *, VkPhysicalDevice, VkSurfaceKHR,
                            terrar_queue *);
...
VkDeviceCreateInfo terrar_create_device_info(VkDeviceQueueCreateInfo *,
                                             uint32_t,
