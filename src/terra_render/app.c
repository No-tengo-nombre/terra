...
terrar_app_config terrar_config_new(const char **validation_layers, const char **device_extensions,
...
terrar_app_config terrar_config_default(void) {
    return terrar_config_new(DEFAULT_VALIDATION_LAYERS, DEFAULT_DEVICE_EXTENSIONS, 1, 1);
}
